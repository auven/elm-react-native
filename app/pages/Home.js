...
const headH = px2dp(isIPhoneX ? 164 : isIOS || Platform.Version > 20 ? 140 : 120)
...
export default class HomePage extends Component {
  ...
  constructor(props) {
    ...
    this.SEARCH_BOX_Y = px2dp(isIOS || Platform.Version > 20 ? 48 : 43)
    this.SEARCH_FIX_Y = headH - px2dp(isIPhoneX ? 88 : isIOS || Platform.Version > 20 ? 64 : 44)
  ...
  _renderFixHeader() {
    ...
    return (
      <Animated.View style={[styles.header, {
        ...
        top: 0,
        bottom: 0,
        height: NavBar.topbarHeight + 5,
        paddingTop: px2dp(isIPhoneX ? 49 : Platform.OS === 'ios' || Platform.Version > 20 ? 25 : 10),
        transform: [
          { translateY: showY }
        ]
      }]}>
  ...
  openLbs() {
    ...
    this.props.navigation.navigate('LbsModal')
  }
  ...
  _renderTypes() {
    ...
    return (
      <Carousel
        ...
        dotActiveStyle={{ backgroundColor: 'rgba(0,0,0,.5)', width: 6, height: 6 }}
      >
...
const styles = StyleSheet.create({
  header: {
    ...
    height: headH,
    paddingTop: px2dp(isIPhoneX ? 54 : isIOS || Platform.Version > 20 ? 30 : 10),
